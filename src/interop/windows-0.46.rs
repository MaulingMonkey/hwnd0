use windows::{
    core::{ComInterface, Error, IntoParam, Param},
...
impl IntoParam<HWND> for crate::HWND        { fn into_param(self) -> Param<HWND> { Param::Owned(self.into()) } }
impl IntoParam<HWND> for crate::NonNullHWND { fn into_param(self) -> Param<HWND> { Param::Owned(self.into()) } }
