...
impl From<crate::HWND       > for InParam<'_, HWND> { fn from(hwnd: crate::HWND         ) -> Self { InParam::owned(hwnd.into()) } }
impl From<crate::NonNullHWND> for InParam<'_, HWND> { fn from(hwnd: crate::NonNullHWND  ) -> Self { InParam::owned(hwnd.into()) } }
